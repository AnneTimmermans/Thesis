# -*- coding: utf-8 -*-
"""
Created on Tue Apr 13 20:56:38 2021
...
#    s = d*np.cos(theta)
    ...
    lines0.append(plt.plot(a,aNt)[0])
...
plt.xlim([0,30000])
#plt.xlim([20,140])
plt.title("dN(z)/dt' against height for s = 300")
plt.xlabel("z(m)")
plt.ylabel("dN(z)/dt'")
plt.show()
...
plt.xlim([0,30000])
#plt.xlim([20,140])
plt.title("N(z) against height numerical for s = 1300")
plt.xlabel("z(m)")
plt.ylabel("N(z)")
plt.show()
